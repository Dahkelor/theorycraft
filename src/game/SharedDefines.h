...
enum CreatureEliteType
{
    ...
    CREATURE_DYNAMIC_MINUS_3       = 5,
    CREATURE_DYNAMIC_MINUS_2       = 6,
    CREATURE_DYNAMIC_MINUS_1       = 7,
    CREATURE_DYNAMIC_EQUAL         = 8,
    CREATURE_DYNAMIC_PLUS_1        = 9,
    CREATURE_DYNAMIC_PLUS_2        = 10,
    CREATURE_DYNAMIC_PLUS_3        = 11,
    CREATURE_DYNAMIC_ELITE_MINUS_3 = 12,
    CREATURE_DYNAMIC_ELITE_MINUS_2 = 13,
    CREATURE_DYNAMIC_ELITE_MINUS_1 = 14,
    CREATURE_DYNAMIC_ELITE_EQUAL   = 15,
    CREATURE_DYNAMIC_ELITE_PLUS_1  = 16,
    CREATURE_DYNAMIC_ELITE_PLUS_2  = 17,
    CREATURE_DYNAMIC_ELITE_PLUS_3  = 18
};
